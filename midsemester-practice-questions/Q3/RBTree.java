...
public class RBTree<T extends Comparable<T>> {
	...
	public boolean prop1=true;
	public boolean prop2=true;
	...
	public boolean testProp1() {
		...
		if (root.colour!=Colour.BLACK)
			return false;
		preOrder(root);
		return prop1; //you are allowed to change this return statement
		// END YOUR CODE
	}
	...
	public boolean testProp2() {
		// START YOUR CODE
		// use a stack to do an iterative inorder traversal of the tree
		preOrder(root);
		return prop2;
		// END YOUR CODE
	}
